...
def plot_randomly_spectra(samples,k,dig_spectra=None,fig_save=None):
    '''
    This function plots "k" number of spectra from the given set of them.
    It also plots digitized spectra if they are provided. 

    -samples: array-like of shape (n_spectra,n_features).
    	Spectral Dataset.
    -k: int. 
    	Number of spectra to be plotted. 
    -dig_spectra: array-like of shape (n_spectra,n_features) (default=None).
        Spectral dataset with digitized spectra.
    -fig_save: string. 
        Name of the file to save the plot. 
    
    Return:
    --------
    A chart with "k" spectra. 
    '''
...
def train_and_test_svm_model(samples,labels,kernel,C=1.,gamma=None,coef0=None,test_size=0.35,cv=10):
    '''
    This function trains a SVM estimator with the parameters provided,
    and tests this model via cross-fold validation. 
    ...
    -kernel: string. 
        It specifies the kernel type to be used in the SVM estimator. 
    ...
    Return:
    --------
    A trained (or fitted) SVM estimador. 
    '''
...
def plot_gridsearch_results(grid_results,fig_save=None):
    '''
    This function plots the grid results depending on the kernel function used. 
    ...
    Return:
    -------
    A chart of the estimator accuracies results versus the parameters of each SVM estimator.
    '''
